import { Flame, RocketIcon } from "lucide-react";
...
const EarlyBird = () => {
  ...
  const items = [
    {
      icon: Rocket,
      title: t("priorityAccessToThePlatform"),
    },
    {
      icon: PartyPopper,
      title: t("invitationToOurExclusiveLaunchEvent"),
    },
    {
      icon: Briefcase,
      title: t("premiumVisibilityInTheMarketplace"),
    },
  ];
  return (
    <div
         ...
         group relative`}
            >
             ...
             group-hover:bg-black group-hover:text-main transition-all duration-300"
                ...
                <h5 className="flex gap-2.5 text-xl items-center">
                  {feature.title}
                </h5>
              </div>
            </div>
