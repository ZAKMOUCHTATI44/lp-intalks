    ...
    <div className="flex flex-col gap-1.5">
      ...
      <div>
        <Popover open={open} onOpenChange={setOpen}>
          ...
          <PopoverContent className="w-[var(--radix-popover-trigger-width)] p-0  border-gray-600">
            <Command className="bg-[#1d1d1d] border-0  border-gray-600">
              <CommandInput
                placeholder="Rechercher mon pays"
                className="h-9 bg-[#1d1d1d] border-gray-600"
              />
              <CommandList className="bg-[#1d1d1d] text-white border-gray-600">
                <CommandEmpty>{t("form.country.empty")}</CommandEmpty>
                <CommandGroup>
